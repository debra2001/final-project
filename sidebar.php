        ...
        <div class="container py-3 d-flex flex-column justify-content-center align-items-center gap-4">
            ...
            <div class="sidebar_items my-3">
                <ul class="list-group text-white">
                    ...
                    <a href="<?php echo APP_URL?>/feedback.php" class="list-group-item bg-transparent border-0 text-white fs-6 sidebar_item <?php echo $_SERVER['REQUEST_URI'] == '/finalyear/feedback.php' ? 'fw-bold': '' ?>"><span class="fa fa-list me-3"></span>feedback</a>
